...
int __stdcall dx_CreateGraphFromGraphImage( const BASEIMAGE * RGBImage , int TextureFlag , int ReverseFlag ) 
{
	return CreateGraphFromGraphImage( RGBImage , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_CreateGraphFromGraphImage_2( const BASEIMAGE * RGBImage , const BASEIMAGE * AlphaImage , int TextureFlag , int ReverseFlag ) 
{
	return CreateGraphFromGraphImage( RGBImage , AlphaImage , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_ReCreateGraphFromGraphImage( const BASEIMAGE * RGBImage , int GrHandle , int TextureFlag , int ReverseFlag ) 
{
	return ReCreateGraphFromGraphImage( RGBImage , GrHandle , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_ReCreateGraphFromGraphImage_2( const BASEIMAGE * RGBImage , const BASEIMAGE * AlphaImage , int GrHandle , int TextureFlag , int ReverseFlag ) 
{
...
int __stdcall dx_CreateDivGraphFromGraphImage_2( BASEIMAGE * RGBImage , const BASEIMAGE * AlphaImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return CreateDivGraphFromGraphImage( RGBImage , AlphaImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_ReCreateDivGraphFromGraphImage( BASEIMAGE * RGBImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , const int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return ReCreateDivGraphFromGraphImage( RGBImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_ReCreateDivGraphFromGraphImage_2( BASEIMAGE * RGBImage , const BASEIMAGE * AlphaImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , const int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
...
{
	return SetUseGPUShaderModel3( Flag);
}
...
int __stdcall dx_FontCacheStringDrawToHandle( int x , int y , const TCHAR * StrData , int Color , int EdgeColor , BASEIMAGE * DestImage , const RECT * ClipRect , int FontHandle , int VerticalFlag , SIZE * DrawSizeP ) 
{
